...
public class InMemoryModifyRecord extends InMemoryRecord {

  private ByteArray value = null;

  public InMemoryModifyRecord(UUID pageId, ByteArray key, ByteArray value) {
    super(pageId, key);
    this.value = value;
  }
